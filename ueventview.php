...
$eventDetails = mysqli_query($conn, "SELECT * FROM event_details ORDER BY eventId DESC");
...
?>
        ...
        <form method="POST" action="#">
            <div class="bg-img">
                ...
                <img src="uploads/<?php echo $event['eventImage']; ?>" width="250" height="250" alt="<?php echo $event['eventName']; ?>">
                <h2>Venue: <?php echo $event["eventVenue"] ?></h2>
                <h2>Date & Time: <?php echo $event["eventDate&Time"] ?></h2>
                ...
                <a href="bookticket.php?eventId=<?php echo $event['eventId']; ?>" class="btn">BOOK NOW</a>
            </div>
        </form>
        <br>
<?php
    ...
    echo "Error fetching event_details: " . mysqli_error($conn);
}
?>
